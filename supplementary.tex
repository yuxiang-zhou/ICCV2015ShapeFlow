...
\begin{figure}[!b]
    ...
    \end{subfigure}
    \caption{Dense shape reconstruction errors for ears and faces. Top: results of dAAMs, bottom: results of AAMs. The normalised point-to-point error is used an evaluation measure. Please notice the major difference in the error scale (vertical axis) between the two plots.}
    \label{fig:rc_face}
\end{figure}
