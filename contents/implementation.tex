...
\begin{figure}[b!]
    ...
    \caption{Exemplar SVS shape representation. The decision function is trained on the set of sparse landmarks. Same SVS shape can be trained with missing data shown in sparse lanmarks. For last figure, jet colourmap shows probabilities of a pixel belonging to the original shape.}
    \label{fig:build_svs}
\end{figure}
